...
*Type a bill (menu rates apply automatically):*
\`\`\`
...
*Or photo:* clear photo of the handwritten bill pad.
System maps items to official menu rates + *5% GST*.

Then *Confirm* → professional Tax Invoice PDF
(GSTIN, HSN 996331, CGST/SGST).
